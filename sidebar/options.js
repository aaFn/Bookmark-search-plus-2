...
// ####
const RetainLastSelectedBookInput = document.querySelector("#retainlastselectedbook");
// ####
...
// ####  
  ,retainlastselectedbook_option: RetainLastSelectedBookInput.checked
// ####  
...
// ####    
    if ((value = res.retainlastselectedbook_option) != undefined) {
      ...
      if (value)  RetainLastSelectedBookInput.checked = true;
    }
// ####
...
// ####
  RetainLastSelectedBookInput.addEventListener("click", saveOptions);
// ####
